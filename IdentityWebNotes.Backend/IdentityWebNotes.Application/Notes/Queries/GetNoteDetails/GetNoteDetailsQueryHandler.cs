...
public class GetNoteDetailsQueryHandler : IRequestHandler<GetNoteDetailsQuery, NoteDetailsModel>
{
    ...
    public async Task<NoteDetailsModel> Handle(GetNoteDetailsQuery request, CancellationToken cancellationToken)
    {
        ...
        // If note is found and user id is equals, map it into NoteDetailsModel and return
        NoteDetailsModel result = _mapper.Map<NoteDetailsModel>(noteEntity);
